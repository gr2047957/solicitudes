...
import { SolicitudesComponent } from 'app/entities/solicitudes/solicitudes.component';
...
describe('Component Tests', () => {
    describe('Solicitudes Management Component', () => {
        let comp: SolicitudesComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(SolicitudesComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.solicitudes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
